...
/**
 * BANK MANAGEMENT SYSTEM - single-file edition.
 *
 * Compile & run with:
 *   javac BankManagementSystem.java
 *   java BankManagementSystem
 *
 * Data is saved to bank_data.ser in the working directory, so accounts
 * persist between runs without needing any external database.
 */
...
class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        ...
        root.add(UITheme.headerBar("\uD83C\uDFE6  Prosperity National Bank"), BorderLayout.NORTH);
